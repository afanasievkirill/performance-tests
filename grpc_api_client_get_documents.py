...
document_gateway_client = build_documents_gateway_grpc_client()
...
get_tarrif_document_response = document_gateway_client.get_tariff_document(
    account_id=open_credit_card_account_response.account.id
)

print("Get tariff document response:", get_tarrif_document_response)
